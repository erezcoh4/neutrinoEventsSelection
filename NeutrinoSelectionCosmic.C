...
//  const string vertexlabel = "pmtrack";
  ...
  const string tracklabel = "pandoraCosmic";
  const string vertexlabel = "pandoraCosmic";
...
//      ch.SetBranchStatus("enu_truth", 1);
//      ch.SetBranchStatus("Q2_truth", 1);
//      ch.SetBranchStatus("W_truth", 1);
//      ch.SetBranchStatus("X_truth", 1);
//      ch.SetBranchStatus("Y_truth", 1);
      ch.SetBranchStatus("nuvtxx_truth", 1);
      ch.SetBranchStatus("nuvtxy_truth", 1);
      ch.SetBranchStatus("nuvtxz_truth", 1);
//      ch.SetBranchStatus("lep_mom_truth", 1);
//      ch.SetBranchStatus("lep_dcosx_truth", 1);
//      ch.SetBranchStatus("lep_dcosy_truth", 1);
//      ch.SetBranchStatus("lep_dcosz_truth", 1);
...
//      ch.SetBranchAddress("enu_truth",enu_truth);
//      ch.SetBranchAddress("Q2_truth",Q2_truth);
//      ch.SetBranchAddress("W_truth",W_truth);
//      ch.SetBranchAddress("X_truth",X_truth);
//      ch.SetBranchAddress("Y_truth",Y_truth);
...
//      ch.SetBranchAddress("lep_mom_truth",lep_mom_truth);
//      ch.SetBranchAddress("lep_dcosx_truth",lep_dcosx_truth);
//      ch.SetBranchAddress("lep_dcosy_truth",lep_dcosy_truth);
//      ch.SetBranchAddress("lep_dcosz_truth",lep_dcosz_truth);
    }
    ...
    for (Long64_t jentry = 0; jentry<nentries; ++jentry){
      ...
      ch.GetEntry(jentry);
      //if (run!=5512||event!=6215) continue;
      //if (run!=5772||event!=715) continue;
      //if (run!=5273||event!=5780) continue;
      //if (run!=5262||event!=2559) continue;
      ++nevents[isample][0];
...
//          sumdEdxEnd /= dEdxMCScale[iplane];
//          sumdEdxStart /= dEdxMCScale[iplane];
//        }
